...
import com.mudit.admin.brand.BrandService;
import com.mudit.admin.category.CategoryService;
...
public class ProductController {
	...
	public String saveProduct(Product product, RedirectAttributes ra,
			...
			@AuthenticationPrincipal BazaarUserDetails loggedUser
			) throws IOException {
	...
	public String editProduct(@PathVariable("id") Integer id, Model model,
			RedirectAttributes ra, @AuthenticationPrincipal BazaarUserDetails loggedUser) {
		try {
