...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		Setting siteName = new Setting("SITE_NAME", "Bazar", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "logo.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2023 Bazar Ltd.", SettingCategory.GENERAL);
