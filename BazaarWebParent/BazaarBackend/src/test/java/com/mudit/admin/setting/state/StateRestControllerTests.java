package com.mudit.admin.setting.state;
...
import com.mudit.admin.setting.country.CountryRepository;
...
public class StateRestControllerTests {
	...
	@Test
	@WithMockUser(username = "mudit", password = "something", roles = "Admin")
	...
	public void testCreateState() throws Exception {
		...
		State state = new State("Ohio", country);
